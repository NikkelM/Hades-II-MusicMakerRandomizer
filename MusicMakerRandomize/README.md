...
Download both the [Hades II Mod Importer](https://github.com/SGG-Modding/ModImporter/releases/latest) ([Nexus](https://www.nexusmods.com/hades2/mods/1)) and the [Mod Util](https://github.com/SGG-Modding/ModUtil/releases/latest) and follow their respective installation instruction.
